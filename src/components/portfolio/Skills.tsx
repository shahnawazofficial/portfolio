...
const groups: Group[] = [
  ...
  },
  {
    ...
    index: "02",
    note: "For keyframes, character references, and concept stills.",
    span: "wide",
    items: [
      { name: "Midjourney v7", url: "https://www.midjourney.com/", primary: true },
      { name: "Flux 1.1 Ultra", url: "https://blackforestlabs.ai/", primary: true },
      { name: "Google Imagen 3", url: "https://deepmind.google/technologies/imagen-3/", primary: true },
      { name: "DALL-E 3", url: "https://openai.com/dall-e-3" },
      { name: "Seedream 5 Pro", url: "https://seedream.ai/" },
  ...
  },
  {
    title: "Editing & Sound",
    index: "04",
    note: "Post-production, pacing, and packaging.",
    span: "wide",
    items: [
      { name: "Premiere Pro", url: "https://www.adobe.com/products/premiere.html", primary: true },
      { name: "DaVinci Resolve", url: "https://www.blackmagicdesign.com/products/davinciresolve", primary: true },
      { name: "Filmora", url: "https://filmora.wondershare.com/", primary: true },
      { name: "Canva", url: "https://www.canva.com/", primary: true },
  ...
  },
  {
    ...
    index: "05",
    note: "For episodic scripts, dramatic structure, and hooks.",
    span: "compact",
    items: [
      { name: "Claude 3.7 Sonnet", url: "https://claude.ai/", primary: true },
      { name: "ChatGPT-4o", url: "https://chatgpt.com/", primary: true },
